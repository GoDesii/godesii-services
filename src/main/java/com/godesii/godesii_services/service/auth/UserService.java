...
public class UserService {
    ...
    public UserService(UserRepository userRepository, SecureTokenService secureTokenService,
            TwilioSmsSenderService twilioSmsSenderService, PasswordEncoder passwordEncoder) {
    ...
    public UserProfileCreateResponse updateProfile(UserProfileCreateRequest request) {
        User existingUser = this.userRepository.findByUsername(request.getUserId())
                .orElseThrow(() -> new ResourceNotFoundException(
                        "User does not exist with username " + request.getUserId()));
