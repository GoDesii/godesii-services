...
import com.godesii.godesii_services.entity.oauth2.Authorization;
...
public final class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
...
//        this.objectMapper.addMixIn(GithubFederalOAuth2User.class, GithubFederalOAuth2UserMixin.class);
//        this.objectMapper.addMixIn(GoogleFederalOAuth2User.class, GoogleFederalOAuth2UserMixin.class);
    }
